...
//	GPIOA -> BSRR |= GPIO_BSRR_BR5;
	...
	GPIOA -> BSRR = 0x18370000;//0 1 2 4 5 11,12
	GPIOB -> BSRR = 0x03C00000;//6 7 8 9
	GPIOC -> BSRR = 0xE0000000;//13 14 15
}
...
void GPIOSetup(void)
{
	GPIOA -> CRL = 0x99110111;
	GPIOA -> CRH = 0x000114B0;

	GPIOB -> CRL = 0x330000BB;
	GPIOB -> CRH = 0x99003333;
...
void UARTSetup(void)
{
	...
	USART1 -> BRR = 0x4E2;//EA6(9600 36) 271(57600 36) 4E2(57600 72) 753(38400 72)
...
void motorCode(uint16_t x, uint16_t y, uint16_t z, uint16_t w, uint16_t c1, uint16_t c2)
{
	TIM3 -> CR1 |= TIM_CR1_CEN;
	TIM3 -> CCER |= TIM_CCER_CC3E;
	TIM3 -> CCER |= TIM_CCER_CC4E;
