...
void GPIOSetup(void)
{
    ...
    //ultrasonic
    GPIOB -> CRH |= (1<<3)|(1<<4)|(1<<5)|(1<<19)|(1<<20)|(1<<21);
    GPIOB -> CRH &= ~(1<<0)&~(1<<1)&~(1<<2)&~(1<<6)&~(1<<7)&~(1<<22)&~(1<<23)&~(1<<18)&~(1<<17)&~(1<<16);
}
